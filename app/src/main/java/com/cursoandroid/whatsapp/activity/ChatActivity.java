...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtiMensagem = findViewById(R.id.editMensagem);
        recyclerMensagens = findViewById(R.id.recyclerMensagens);
        imageCamera = findViewById(R.id.imageCamera);

        //recupera dados do usuário remetente
        idUsuarioRemetente = UsuarioFirebase.getIdenrificadorUsuario();
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if ( usuarioDestinatario != null ) { //Mensagem normal
                                ...
                                for ( Usuario membro: grupo.getMembros() ) {
                                    ...
                                    String idUsuarioLogadoGrupo = UsuarioFirebase.getIdenrificadorUsuario();
    ...
    public void enviarMensagem(View view) {
        ...
        String textoMensagem = edtiMensagem.getText().toString();
